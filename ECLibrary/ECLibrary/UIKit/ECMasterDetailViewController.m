//
//  ECMasterDetailViewController.m
//  ECLibrary
//
...
@interface ECMasterDetailViewController ()
- (void)addMasterGestureRecognizers;
@end

@implementation ECMasterDetailViewController
...
- (void)loadView {
    ...
    CGRect viewFrame = [UIViewController ecAvailableScreenSize];
    ...
    [UIViewController ecGetMasterViewFrame:&masterFrame andDetailViewFrame:&detailFrame splitAtPercent:_portraitSplitAmount fromContainerView:viewFrame];
    else
    [UIViewController ecGetMasterViewFrame:&masterFrame andDetailViewFrame:&detailFrame splitAtPercent:_landscapeSplitAmount fromContainerView:viewFrame];
...
- (void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation
    ...
    CGRect viewFrame = [UIViewController ecOrientedFrameForFrame:self.view.frame];
...
- (void)focusOnDetailView {
    ...
    if ( UIInterfaceOrientationIsPortrait([UIViewController ecCurrentInterfaceOrientation]))
    [UIViewController ecGetMasterViewFrame:&masterFrame andDetailViewFrame:&detailFrame splitAtPercent:0.10f fromContainerView:viewFrame];
    else
    [UIViewController ecGetMasterViewFrame:&masterFrame andDetailViewFrame:&detailFrame splitAtPercent:_landscapeSplitAmount fromContainerView:viewFrame];
